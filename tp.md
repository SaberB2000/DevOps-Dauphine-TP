...
information_schema             systeme 		
mysql		                   systeme
performance_schema	           systeme
sys		                       systeme
...
2. Lancer l'image docker et ouvrez un shell à l'intérieur de votre container:
   ...
   ce code est le point d'entrée de votre site WordPress. Lorsqu'un utilisateur accède au site, ce fichier est appelé en premier. Il dit à WordPress de charger le thème et d'initialiser le système, ce qui permet d'afficher votre site web avec le thème configuré.
...
3. Supprimez le container puis relancez en un en spécifiant un port binding (une correspondance de port).
   ...
   Avec le port spécifié on a rien, par contre avec un autre port on a un message qui dit que la connection est rfesée 
...
AH00558: apache2: Could not reliably determine the server's fully qualified domain name, using 172.18.0.2. Set the 'ServerName' directive globally to suppress this message
[Thu Oct 05 08:23:01.628707 2023] [mpm_prefork:notice] [pid 1] AH00163: Apache/2.4.56 (Debian) PHP/8.0.30 configured -- resuming normal operations
[Thu Oct 05 08:23:01.628950 2023] [core:notice] [pid 1] AH00094: Command line: 'apache2 -D FOREGROUND'
172.18.0.1 - - [05/Oct/2023:08:24:22 +0000] "GET / HTTP/1.1" 302 235 "-" "curl/7.74.0"
...
Couldn't connect to a server on port 7000. Ensure you have selected the correct port with a HTTP server running on it.
